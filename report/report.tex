...
\end{lstlisting}
	...
	A user of the funcon can import just the needed funcons and read only those.

	\subsubsection{Extra features}
	We have added a few extra features in comparison to the \ASFSDF generation.
	
	\begin{itemize}
		\item Support for the aliassed funcon names.
		\item Informal description of funcon is included as documentation per
		funcon (using \Rascal's \code{@doc\{\}} source code annotation) .
	\end{itemize}
